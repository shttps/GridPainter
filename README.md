...
<p align="center">
  <a href="https://shttps.github.io/GridPainter/"><b>▶ Открыть редактор онлайн</b></a>
  &nbsp;·&nbsp;
  Discord: <b>@ahttps</b>
</p>
...
1. Открой [редактор онлайн](https://shttps.github.io/GridPainter/) или скачай репозиторий и открой `index.html`. Ничего устанавливать не нужно. Chrome или Edge лучше всего: они умеют записывать файл на место.
...
© 2026 shttps. **Все права защищены.** Редактором можно пользоваться для своих сеток, а созданные рисунки — твои. Копировать, изменять, распространять и продавать сам проект без письменного разрешения автора нельзя. Подробности — в [LICENSE](LICENSE). По вопросам лицензии и покупки: Discord **@ahttps**.
